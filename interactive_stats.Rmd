...
card_names_list <- lapply(quantity_list, function(i){
  lapply(i$id, scry_card)
  })


card_names <- lapply(t[[1]]$id, scry_card)

list_data_list <- lapply(card_names_list,  Map, as.frame)
